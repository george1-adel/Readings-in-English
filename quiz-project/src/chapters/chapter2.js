// أسئلة الوحدة الثالثة والرابعة (نظام التعليم والوسائل التعليمية) - 60 سؤالاً

window.chapter2Questions = [
    // ===== الوحدة الثالثة: نظام التعليم =====
    // --- صح وخطأ ---
    {
    ...
    // --- اختيار من متعدد ---
    {
        question: "Which of the following is NOT a component of an educational system?",
        answers: [
            "Educational Inputs",
    ...
    {
        question: "What does 'Feedback' primarily aim to do in an educational system?",
        answers: [
            "Transform inputs into outputs.",
            "Identify the main educational problem.",
            "Give indications of objectives achievement.",
    ...
    {
        question: "Which stage of the ADDIE model involves identifying the main educational problem and analyzing the educational environment?",
        answers: [
            "Design",
            "Development",
            "Analysis",
    ...
    {
        question: "If an educational problem involves students with poor eyesight, what would be a logical solution regarding the educational system?",
        answers: [
            "Relying solely on visual aids.",
            "Using books in Braille and audio technology.",
    ...
    {
        question: "The goal of the ancient Spartan community to make every male a soldier led to an educational system that:",
        answers: [
            "Focused on artistic and literary studies.",
            "Engaged male children in military training camps.",
            "Provided financial support for all students.",
    ...
    {
        question: "Which of the following is considered an 'educational input' in an educational system?",
        answers: [
            "Skillful graduates",
    ...
    {
        question: "The process of managing educational resources and technological tools falls under which combination of educational technology?",
        answers: [
            "Design",
            "Development",
            "Management",
    ...
    {
        question: "What is the primary role of 'Instructional design models'?",
        answers: [
            "To analyze educational problems.",
            "To represent patterns for shaping curricula and educational aids.",
    ...
    {
        question: "In the ADDIE model, collecting educational resources to form learners' experiences occurs in which stage?",
        answers: [
            "Analysis",
            "Design",
            "Development",
    ...
    {
        question: "What is the primary focus of the 'Analysis' stage in the ADDIE model?",
        answers: [
            "Designing a teaching scheme.",
            "Identifying the main educational problem.",
    ...
    {
        question: "Which of the following is a characteristic of a successful educational system?",
        answers: [
            "Limiting parents' involvement in academic decisions.",
    ...
    {
        question: "The relationship between educational systems and educational technology is linked through:",
        answers: [
    ...
    {
        question: "In India, the educational system emphasizes professional skills and technology sources due to which learner feature?",
        answers: [
            "High academic competition.",
            "Diverse religious backgrounds.",
            "Children being forced to work early due to poverty.",
    ...
    {
        question: "What is the definition of a 'system' according to the source?",
        answers: [
            "A collection of unrelated elements.",
            "An integrated whole of interacting parts for specific outputs.",
    ...
    {
        question: "'Educational operations' in an educational system include:",
        answers: [
            "Fund allocation and human resource management.",
            "Teaching, scientific conferences, and classroom activities.",
            "Producing skillful graduates.",
    ...
    // ===== الوحدة الرابعة: الوسائل التعليمية =====
    // --- صح وخطأ ---
    {
    ...
    // --- اختيار من متعدد ---
    {
        question: "Which of the following is an example of an 'Audiovisual Aid'?",
        answers: [
            "Radio",
            "Textbook",
            "Video tutorials",
    ...
    {
        question: "A language lab and a data show projector are examples of aids classified by the number of users as:",
        answers: [
            "Individual Aids",
            "Group Aids",
            "Mass Aids",
    ...
    {
        question: "Which of the following aids is classified as 'Static Aid'?",
        answers: [
    ...
    {
        question: "Educational boards and educational samples are examples of aids classified as:",
        answers: [
            "View-with-Devices Aids",
            "View-without-Devices Aids",
            "Double-View Aids",
            "Electronic Aids"
        ],
        correctAnswer: 1,
    ...
    {
        question: "What type of aid is a microscope, which the teacher selects but does not make?",
        answers: [
            "Made Aid",
            "Ready-Use Aid",
            "Major Aid",
    ...
    {
        question: "When museums are used in history courses as an additional teaching method, they are classified as:",
        answers: [
            "Major Aids",
            "Complementary Aids",
            "Enrichment Aids",
    ...
    {
        question: "Which production method for educational aids uses modern technology such as computers and mobile applications?",
        answers: [
            "Mechanical Aids",
            "Manual Aids",
            "Electronic Aids",
    ...
    {
        question: "Which of the following is NOT a criterion for selecting and evaluating educational aids?",
        answers: [
            "Attracts students' attention.",
            "Replaces the teacher's role entirely.",
    ...
    {
        question: "What is one of the key importance points of educational aids?",
        answers: [
            "Increasing monotony and boredom.",
            "Facilitating learner awareness of experiences.",
            "Limiting individual learning.",
    ...
    {
        question: "A mobile phone can be classified into multiple categories. Which of the following is NOT listed as one of its classifications in the source?",
        answers: [
            "Multi senses",
            "Individual",
            "Static",
    ...
    {
        question: "What type of aid relies only on the sense of hearing?",
        answers: [
            "Visual Aids",
            "Audiovisual Aids",
            "Audio Aids",
    ...
    {
        question: "If an educational aid can be viewed with or without devices, like educational graphics and images, it is classified as:",
        answers: [
            "View-with-Devices Aids",
            "View-without-Devices Aids",
            "Double-View Aids",
    ...
    {
        question: "What is the primary purpose of educational aids regarding individual differences?",
        answers: [
            "To ignore them.",
    ...
    {
        question: "Microsoft PowerPoint lectures, created by the teacher, are classified as:",
        answers: [
            "Ready-Use Aids",
            "Major Aids",
            "Made Aids",
    ...
    {
        question: "The importance of educational aids includes all of the following EXCEPT:",
        answers: [
            "Reducing monotony and boredom.",
            "Maintaining and storing experience.",
            "Limiting the development of critical thinking.",
